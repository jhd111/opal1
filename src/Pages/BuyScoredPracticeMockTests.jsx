...
//               {/* Country Selector */}
//               <div className="bg-white border border-gray-200 rounded-2xl p-4 flex items-center justify-between cursor-pointer hover:bg-gray-50 transition-colors">
//                 <div className="flex items-center gap-3">
//                   <div className="w-8 h-6 bg-green-600 rounded flex items-center justify-center relative overflow-hidden">
//                     <svg className="w-4 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
//                       <path d="M12 2L13.09 8.26L22 9L13.09 9.74L12 16L10.91 9.74L2 9L10.91 8.26L12 2Z"/>
//                     </svg>
//                   </div>
//                   <span className="text-gray-800 font-medium poppins">
//                     Pakistan
//                   </span>
//                 </div>
        ...
        <div className="w-full">
          ...
          <div className="mb-6 p-6 bg-white border border-2-[#F1F1F3] rounded-2xl">
            ...
            <div className="space-y-4">
              ...
              {/* Country Selector */}
              <div className="rounded-full w-[70%] bg-[#F2F4F7] p-4 flex justify-between">
