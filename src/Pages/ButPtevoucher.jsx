...
const ButPtevoucher = () => {
    ...
    >
      ...
      <div className="mb-6">
        <div className="flex items-center gap-x-2">
          <p className="text-2xl font-light">Rs. {Math.floor(deal.price)}/-</p>
  ...
  <p className="font-semibold text-black mb-4">Key Features</p>
  <ul className="text-sm text-gray-700 space-y-2 mb-6">
    {splitFeatures(deal.key_features).map((feature, index) => (
