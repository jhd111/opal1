...
const BuyPteVoucherHero = () => {
  return (
    <div className="relative">
      ...
      <div className="w-[90%] md:w-[80%] lg:w-[75%] xl:w-[83%] bg-white relative md:absolute rounded-md md:left-[10%] lg:left-[13%] xl:left-[8.5%] 2xl:left-[8.5%] mt-10 md:bottom-8 lg:-bottom-16 xl:-bottom-14 2xl:-bottom-12 grid grid-cols-3 md:grid-cols-5 gap-4 shadow-md mx-auto py-4 px-2">
