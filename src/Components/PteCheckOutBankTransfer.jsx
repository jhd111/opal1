...
import { BookWithUs } from "../Services/BookwiuthUs";
import toast from 'react-hot-toast';

const PteCheckOutBankTransfer = ({ set }) => {
  const [block, setblock] = useState(1);
  const [selectedFile, setSelectedFile] = useState(null);

  const [formData, setFormData] = useState({
    type: "Book Exam With Us", // Default type
    full_name: "",
    email: "",
    phone_number: "",
    account_title: "",
...
const handleSubmit = (e) => {
  ...
  const submitData = new FormData();
  submitData.append('form_type', formData.type);
  submitData.append('full_name', formData.full_name);
  submitData.append('email', formData.email);
  submitData.append('phone_number', formData.phone_number);
  submitData.append('account_title', formData.account_title);
...
//   submitData.append("test_type","")
//   submitData.append("test_date","")
//   submitData.append("test_center","")
//   submitData.append("student_name","")
//   submitData.append("payment_screenshot","")
//   submitData.append("passport_number","")
//   submitData.append("country","")
//   submitData.append("city","")
//   submitData.append("birth_country","")
//   submitData.append("birth_city","")
...
export default PteCheckOutBankTransfer;